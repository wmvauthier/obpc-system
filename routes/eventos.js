...
router.get('/api/insertEvent', login.opcional, EventosController.insertEvent);
router.get('/api/insertTicket', login.opcional, EventosController.insertTicket);
router.get('/api/insertTicketPersona', login.opcional, EventosController.insertTicketPersona);
